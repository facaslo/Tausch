...
const getOffers = async (req) => {
    ...
    try{
        ...
        result = await client_pool.query(`SELECT id_publicacion_receptor, email_proponente, confirmacion_receptor, confirmacion_proponente, estado_propuesta, fecha_propuesta, nombres, apellidos, mensaje, titulo, id, categoria, descripcion, estado_item, imagen
